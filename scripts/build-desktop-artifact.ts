...
const DESKTOP_APP_ID = "com.cubic.cubicone";
...
export function resolveDesktopProductName(version: string): string {
  return resolveDesktopUpdateChannel(version) === "nightly"
    ? "CubicOne (Nightly)"
    : (desktopPackageJson.productName ?? "CubicOne");
}
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    artifactName: "CubicOne-${version}-${arch}.${ext}",
    ...
    buildConfig.mac = {
      ...
      extendInfo: {
        NSScreenCaptureUsageDescription:
          "CubicOne captures the active window when you use the window capture shortcut.",
      },
      protocols: [
        {
          name: "CubicOne",
