...
Terms whose meaning matters across CubicOne. Architecture and lifecycle constraints belong in the
...
| CubicOne home  | The base data directory. Runtime state normally lives under its `userdata` directory.             |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime CubicOne controls, such as Codex or Claude Code.                                           |
...
| Adapter             | The boundary translating a provider's native protocol into CubicOne operations and events.                   |
