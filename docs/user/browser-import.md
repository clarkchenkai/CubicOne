...
On macOS, Safari imports need Full Disk Access. Choose **Allow**, drag CubicOne into the
System Settings permission list, and turn access on. **Continue** becomes available when access
is detected. macOS may require you to quit and reopen CubicOne before the grant applies; reopen
