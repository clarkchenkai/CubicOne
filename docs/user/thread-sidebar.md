...
When you change a new thread's project, CubicOne stays in the current environment
...
If dragging is unavailable for one environment, update the CubicOne server running in that
