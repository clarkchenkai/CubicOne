...
T3CODE_PORT=13773 \
  "/Applications/CubicOne (Alpha).app/Contents/MacOS/CubicOne (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/CubicOne (Alpha).app"
codesign -d --entitlements :- "/Applications/CubicOne (Alpha).app"
```
