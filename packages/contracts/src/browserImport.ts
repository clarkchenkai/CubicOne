 ...
 * machine into a CubicOne browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** CubicOne profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give CubicOne Full Disk Access in System Settings → Privacy & Security, then retry.",
