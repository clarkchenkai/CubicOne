            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but CubicOne could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but CubicOne still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
