...
const RELEASE_ASSETS = {
  ...
  androidAdaptiveForeground,
  androidAdaptiveBackgroundColor: "#F9601A",
    ...
    widgets: [
      {
        ...
        description: "Subscription quotas from your connected CubicOne environments.",
        configuration: {
      ...
      },
      {
        ...
        description: "Shows the current state of active CubicOne agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow CubicOne to connect to CubicOne servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow CubicOne to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow CubicOne to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow CubicOne to access your camera so you can scan pairing QR codes.",
