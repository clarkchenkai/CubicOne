  ...
  const handleDeviceNotificationsChange = useCallback(
    (enabled: boolean) => {
      ...
      Alert.alert(
        ...
        "Open system Settings to disable notifications for CubicOne.",
        [
          { text: "Cancel", style: "cancel" },
          { text: "Open Settings", onPress: () => void Linking.openSettings() },
        ],
      ...
      >
        <View className="gap-3">
          ...
          <Text className="px-2 text-sm text-foreground-muted">
            CubicOne works locally without signing in. Cloud features are optional.
          </Text>
        </View>
              ...
              onPress={() => {
                void openAndroidLiveUpdateSettings().catch(() => {
                  Alert.alert(
                    ...
                    "Open Android Settings, select CubicOne, then enable Live Updates in Notifications.",
                  );
                });
              }}
            />
