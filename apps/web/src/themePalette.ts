...
/**
 * The palette CubicOne wears with no theme installed, captured from the app's
...
/**
 * The standard CubicOne look as a theme palette, for seeding a new theme when
...
/**
 * The status colors CubicOne shows without a theme, read from the app's own
